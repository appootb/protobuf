...
* [Channel](#channel) - Channel service.
	...
	* [Add (/relation/channel/{target})](#add) - Follow channel.


	* [Cancel (/relation/channel/{id})](#cancel) - Unfollow channel.
...
* Response Type: ***ChannelInfo***

>  Channel info.

|Field|proto type|JSON type|Comment|Default|Required|
|---|---|---|---|---|---|
|id|int64|string| Channel ID|-|true|
|name|string|string| Channel name|-|true|
|description|string|string| Channel description|-|false|
|created_at|[Timestamp](#timestamp)|string ("1972-01-01T10:00:20.021Z")| Channel created time|-|true|
|updated_at|[Timestamp](#timestamp)|string ("1972-01-01T10:00:20.021Z")| Channel updated time|-|true|
