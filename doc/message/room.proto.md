...
* [Room](#room) - Room message service.


	* [Dispatch (/message/room/{id}/server)](#dispatch) - Get room connection server.
...
|Field|proto type|JSON type|Comment|Default|Required|
|---|---|---|---|---|---|
|host|string|string| Room server host name or ip address|-|true|
|port|int|number/string| Room server port|443|false|
|secure|bool|true, false| TLS supported|true|false|
