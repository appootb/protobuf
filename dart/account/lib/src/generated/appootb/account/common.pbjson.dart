...
const AccountInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'gender', '3': 5, '4': 1, '5': 14, '6': '.appootb.account.Gender', '10': 'gender'},
    const {'1': 'signs', '3': 6, '4': 1, '5': 9, '10': 'signs'},
    const {'1': 'location', '3': 7, '4': 1, '5': 9, '10': 'location'},
    const {'1': 'secret', '3': 8, '4': 1, '5': 11, '6': '.appootb.account.Secret', '10': 'secret'},
...
const AccountInfos$json = const {
  '1': 'AccountInfos',
  '2': const [
    const {'1': 'infos', '3': 1, '4': 3, '5': 11, '6': '.appootb.account.AccountInfo', '10': 'infos'},
  ],
};
