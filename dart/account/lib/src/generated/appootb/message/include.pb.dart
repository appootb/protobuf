...
class Postmark extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Postmark', package: const $pb.PackageName('appootb.message'), createEmptyInstance: create)
    ...
    ..aOM<$2.Duration>(8, 'expire', subBuilder: $2.Duration.create)
    ..aOM<$0.Timestamp>(9, 'timestamp', subBuilder: $0.Timestamp.create)
  ;
  ...
  @$pb.TagNumber(8)
  $2.Duration get expire => $_getN(4);
  @$pb.TagNumber(8)
  set expire($2.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasExpire() => $_has(4);
  @$pb.TagNumber(8)
  void clearExpire() => clearField(8);
  @$pb.TagNumber(8)
  $2.Duration ensureExpire() => $_ensure(4);

  @$pb.TagNumber(9)
  $0.Timestamp get timestamp => $_getN(5);
  @$pb.TagNumber(9)
  set timestamp($0.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
