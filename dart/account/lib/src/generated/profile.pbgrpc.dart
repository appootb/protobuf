...
class ProfileClient extends $grpc.Client {
  static final _$set = $grpc.ClientMethod<$8.Property, $3.Empty>(
  ...
  static final _$gets = $grpc.ClientMethod<$3.Empty, $8.Properties>(
  ...
  $grpc.ResponseFuture<$3.Empty> set($8.Property request,
  ...
  $grpc.ResponseFuture<$8.Properties> gets($3.Empty request,
      {$grpc.CallOptions options}) {
...
abstract class ProfileServiceBase extends $grpc.Service {
  ...
  ProfileServiceBase() {
    $addMethod($grpc.ServiceMethod<$8.Property, $3.Empty>(
        'Set',
        set_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$8.Property, $8.Property>(
        ...
        ($core.List<$core.int> value) => $8.Property.fromBuffer(value),
        ($8.Property value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.Empty, $8.Properties>(
        'Gets',
        gets_Pre,
        false,
        false,
  ...
  $async.Future<$3.Empty> set($grpc.ServiceCall call, $8.Property request);
  $async.Future<$8.Property> get($grpc.ServiceCall call, $8.Property request);
  $async.Future<$8.Properties> gets($grpc.ServiceCall call, $3.Empty request);
}
